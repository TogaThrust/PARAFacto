...
{
    private const string OutlookSupportUrl =
    ...
    private const string AdobeReaderUrl = "https://www.adobe.com/be_fr/acrobat/pdf-reader.html";
    ...
    public static string BuildPrerequisiteMessage(bool readerOk, bool outlookOk)
    {
        ...
        return
            ...
            readerLine + "\n" +
            outlookLine +
            "\n\nTéléchargements officiels (copier-coller dans le navigateur si besoin) :\n" +
            $"Reader : {AdobeReaderUrl}\n" +
            $"Outlook classique : {OutlookSupportUrl}\n\n" +
